...
void
decode(_ushort* new_pc, int exec, _ushort old_pc)
{
   ...
   if (exec != 2)
   {
      ...
      {
        // printf("   a1=%u*type1=%u*a2=%u*type2=%u", a1,  current_instr.type1, a2, current_instr.type2);
         print(current_instr.func(a1, current_instr.type1, a2, current_instr.type2), old_pc, a1, a2);
      }
   }
